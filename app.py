...
# Paramètres / Sécurité
# =========================
# Configuration via secrets.toml ou variables d'environnement
PG_HOST = st.secrets.get("postgres", {}).get("host", os.getenv("PG_HOST", "localhost"))
PG_PORT = st.secrets.get("postgres", {}).get("port", os.getenv("PG_PORT", "5432"))
PG_DB = st.secrets.get("postgres", {}).get("dbname", os.getenv("PG_DB", "pointage_db"))
PG_USER = st.secrets.get("postgres", {}).get("user", os.getenv("PG_USER", "postgres"))
PG_PASS = st.secrets.get("postgres", {}).get("password", os.getenv("PG_PASS", "salma2004"))
